...
. '<p>' . _("Pin Code").': ' . $row->pin_code . '</p></br>'
. '<p>' . _("PIN code - a combination of characters and numbers that will be used to confirm all requests for withdrawals from your trading account.") . '</p>'
